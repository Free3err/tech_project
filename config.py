...
PERSON_DETECTION_CLUSTER_DISTANCE = 0.7
PERSON_MIN_CLUSTER_SIZE = 0.05
PERSON_MAX_CLUSTER_SIZE = 2.0
OBSTACLE_MIN_DISTANCE = 0.4
LIDAR_MAX_RANGE = 1.2
...
LOADING_CONFIRMATION_TIMEOUT = 10.0
QR_SCAN_TIMEOUT = 10.0
...
STATE_TIMEOUT_VOICE_VERIFICATION = 0  # Без таймаута, повторяется до успеха
